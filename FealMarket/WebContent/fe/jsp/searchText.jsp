			...
			<div class="am-g am-g-fixed">
				<div class="am-u-sm-12 am-u-md-12">
					...
					<ul class="am-pagination am-pagination-right">
						...
						<!--上一页 -->
						<li><a
							href="/FealMarket/ProductServlet?method=search&pageNum=<%=(pageBean.getPageNumber()-1)%>&index_none_header_sysc=<%=searchText%>">&laquo;</a></li>
						<% }
						...
						<li class="am-active"><a
							href="/FealMarket/ProductServlet?method=search&pageNum=<%=i%>&index_none_header_sysc=<%=searchText%>"><%=i %></a></li>
						<%
						...
						<% }else{%>
						<li><a
							href="/FealMarket/ProductServlet?method=search&pageNum=<%=(pageBean.getPageNumber() + 1) %>&index_none_header_sysc=<%=searchText%>">&raquo;</a></li>
						<% }
							}
						%>
